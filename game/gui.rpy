...
## 游戏内文本使用的字体。
define gui.text_font = "SourceHanSansHWSC-Regular.otf"

## 角色名称使用的字体。
define gui.name_text_font = "SourceHanSansHWSC-Regular.otf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SourceHanSansHWSC-Regular.otf"
